const CACHE='zc2-arena-v5-8-self-hosted-fonts';
const ASSETS=["./","./index.html","./styles.css","./arcade.css","./app.js","./arcade.js","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png","./font-bebas-neue-400.woff2","./font-barlow-condensed-600.woff2","./font-barlow-condensed-700.woff2","./font-barlow-condensed-800.woff2","./font-barlow-condensed-900.woff2","./font-inter.woff2","./font-material-symbols-rounded.woff2","./community-arena-main.webp","./community-arena-emblem.png","./community-arena-join.webp","./community-battlefield.webp","./share-preview.jpg","./jw-eds-yellow.png","./zc2-zombie-smash-promo.png","./player-transparent.png","./zombie-normal.png","./zombie-runner.png","./zombie-helmet.png","./zombie-armored.png","./zombie-toxic.png","./zombie-brute.png","./zombie-berserker.png","./zombie-titan.png","./console-shell-premium.jpg","./console-shell-elite.jpg","./map-concrete.jpg","./map-desert.jpg","./map-north.jpg","./map-hangar.jpg","./map-wasteland.jpg","./skin-gunmetal.jpg","./skin-hazard.jpg","./skin-neon.jpg","./skin-jacko.jpg","./skin-milspec.jpg","./skin-arcade.jpg","./skin-blood.jpg","./skin-toxic.jpg","./skin-gold.jpg","./skin-founders.jpg","./skin-phantom.jpg"];
